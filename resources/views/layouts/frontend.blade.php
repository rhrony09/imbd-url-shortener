        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img class="nav-logo" src="{{ asset("uploads/logos/$settings->logo") }}" alt="{{ $settings->site_name }}">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="btn btn-outline-secondary auth-btn" href="{{ route('register') }}">Register</a>
                            </li>
                        @else
                        ...
                        @endguest
                        <li class="nav-item">
                            <a class="btn brand-btn auth-btn" href="{{ route('download') }}">
