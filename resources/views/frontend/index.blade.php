                                    ...
                                    @if (session('url'))
                                        <div class="mt-3">
                                            ...
                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control" id="shortUrlResult" value="{{ route('redirect', session('url')->slug) }}" readonly>
                                                <button class="btn brand-btn copy-btn" type="button" data-clipboard-target="#shortUrlResult">
                    ...
                    <form method="POST" action="{{ route('urls.store') }}" class="url-shortener-form">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" class="form-control form-control @error('original_url') is-invalid @enderror" id="original_url" name="original_url" placeholder="https://paste-your-long-url-here.com" value="{{ old('original_url') }}" required autofocus>
                            </div>
                            @error('original_url')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('custom_slug') is-invalid @enderror" id="custom_slug" name="custom_slug" placeholder="my-custom-link" value="{{ old('custom_slug') }}">
                            </div>
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" class="btn brand-btn btn-lg">
                                <i class="fa-light fa-bolt-lightning"></i> Shorten URL
                            </button>
                        </div>
                    </form>
                </div>
