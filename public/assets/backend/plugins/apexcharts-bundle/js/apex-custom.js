$(function () {
	...
	var options = {
		...
		colors: ["var(--rh-primary-color)", "#212529"],
		title: {
	...
	var options = {
		...
		colors: ["var(--rh-primary-color)", "#17a00e", "#f41127"],
		stroke: {
			width: [0, 2, 5],
			curve: 'smooth'
		},
	...
	var options = {
		...
		colors: ["var(--rh-primary-color)", "#6c757d", "#17a00e", "#f41127", "#ffc107"],
	...
	var options = {
		...
		colors: ["var(--rh-primary-color)", "#212529", "#17a00e", "#f41127", "#ffc107"],
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
	...
	var options = {
		...
		colors: ["var(--rh-primary-color)", "#212529", "#17a00e"],
		title: {
	...
	var options = {
		...
		colors: ["var(--rh-primary-color)", "#17a00e", "#f41127", "#ffc107"],
